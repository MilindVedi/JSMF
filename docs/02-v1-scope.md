...
| **Performance / Statistics** | Accuracy, total questions attempted, correct vs. incorrect breakdowns, subject-wise performance, per-test performance, and revision/wrong-question statistics, so students can track their progress over time. |
